...
/// - `url`: Target deeplink or custom URL (e.g. `ahnumcl://...`)
...
///     "ahnumcl://add-auth-server?url=https%3A%2F%2Fexample.com".to_string(),
///     None,
/// )?;
///
/// create_url_shortcut(
///     app,
///     "Launch".to_string(),
///     "ahnumcl://launch?id=OFFICIAL_DIR:1.20.1".to_string(),
