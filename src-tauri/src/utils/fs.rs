...
/// - `url`: Target deeplink or custom URL (e.g. `anumcl://...`)
...
///     "anumcl://add-auth-server?url=https%3A%2F%2Fexample.com".to_string(),
///     None,
/// )?;
///
/// create_url_shortcut(
///     app,
///     "Launch".to_string(),
///     "anumcl://launch?id=OFFICIAL_DIR:1.20.1".to_string(),
